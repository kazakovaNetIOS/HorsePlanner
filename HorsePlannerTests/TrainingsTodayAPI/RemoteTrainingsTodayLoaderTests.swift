...
class RemoteTrainingsTodayLoaderTests: XCTestCase {
    ...
    func test_load_deliversErrorOnCLientsError() {
        ...
        expect(sut, toCompleteWith: .failure(RemoteTrainingsTodayLoader.Error.connectivity), when: {
    ...
    func test_load_deliversErrorOnNon200HTTPResponse() {
        ...
        samples.enumerated().forEach { index, code in
            expect(sut, toCompleteWith: .failure(RemoteTrainingsTodayLoader.Error.invalidData), when: {
    ...
    func test_load_doesNotDeliverResultAfterSUTInstanceHasBeenDeallocated() {
        ...
        var sut: RemoteTrainingsTodayLoader? = RemoteTrainingsTodayLoader(url: url, client: client)
    ...
    private func expect(_ sut: RemoteTrainingsTodayLoader,
                        toCompleteWith expectedResult: RemoteTrainingsTodayLoader.Result,
                        when action: () -> Void,
                        file: StaticString = #filePath,
                        line: UInt = #line) {
        ...
        sut.load { receivedResult in
            ...
            case let (.failure(receivedError as RemoteTrainingsTodayLoader.Error),
                      .failure(expectedError as RemoteTrainingsTodayLoader.Error)):
